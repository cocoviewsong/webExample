// function button(){
//     document.getElementById("buttonsearch").style.color="red";
// }
// // $(buttonsearch)
...
// $("bt").onclick=displayDate;
// function displayDate() {
//     document.getElementById("bt").innerHTML = Date();
//   }

// var xhr =new XMLHttpRequest()
// xhr.open('get','http://localhost:3000/search?keywords=啦啦啦',true)
// xhr.send()
